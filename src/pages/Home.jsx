...
function Home() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-dark-brown text-white min-h-[90vh] md:py-32 overflow-hidden flex items-start md:items-center pt-24 md:pt-0">
        ...
        <div className="w-full px-4 xl:px-24 mx-auto relative min-h-[90vh] flex flex-col justify-between">
